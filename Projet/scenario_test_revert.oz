   ...
   scenario(bombLatency:3
	    ...
	    snakes: [
		     ...
		     snake(team:green name:steve
			   ...
			   effects: nil
			   strategy: [forward forward turn(right) repeat([forward] times:3) turn(right) forward turn(right) forward turn(left) repeat([forward] times:22)]
			   bombing: false|false|false|false|false|false|true|NoBomb
			  )
